...
//______________________Enemy Update state 1______________________
// .section .data
// scaling_factor: .double 1.25
...
//     vldr d0, [sp]         @ Load homing from the stack into d0
//     vldr d1, [sp, #8]     @ Load velocity from the stack into d1

//     @ Load the scaling factor into d2
//     vldr d2, =scaling_factor

//     @ Call the std::cos function
//     bl cos

//     @ Multiply the result by velocity * 1.25
//     vmul.f64 d0, d0, d1
//     vmul.f64 d0, d0, d2
...
// extern double updateCos(double homing, double velocity);
// extern double updateSin(double homing, double velocity);

// int main() {
//     double homing = M_PI / 4.0;  // 45 degrees in radians
//     double velocity = 2.0;

//     double cosResult = updateCos(homing, velocity);
//     double sinResult = updateSin(homing, velocity);

//     printf("Updated Cosine: %f\n", cosResult);
//     printf("Updated Sine: %f\n", sinResult);
